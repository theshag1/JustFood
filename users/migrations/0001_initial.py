    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.SmallIntegerField(blank=True, help_text='Required . 18 years older only ! ', null=True)),
                ('job', models.CharField(max_length=500)),
                ('first_name', models.CharField(blank=True, null=True)),
                ('last_name', models.CharField(blank=True, null=True)),
                ('balance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='online_balance', to='OnlinePay.paymethod')),
